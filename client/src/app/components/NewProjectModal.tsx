                ...
                <div className="modal-dialog relative w-auto pointer-events-none">
                    <div
                        ...
                        <div
                            ...
                            {/* Title */}
                            <h5 className="text-xl font-medium leading-normal text-gray-800" id="projectModalLabel">Modal title</h5>
                        ...
                        <div
                            ...
                            <button type="button" className="px-6 py-2.5 bg-blue-600 text-white font-medium text-xs uppercase rounded ml-1">
                                Save changes
                            </button>
                        </div>
